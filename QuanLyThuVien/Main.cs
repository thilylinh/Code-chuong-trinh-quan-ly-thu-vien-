    ...
    public partial class Main : Form
    {
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                connnectionString = "Data Source=DESKTOP-OOTPH21;Initial Catalog=Library;User ID=sa;Password=123456";
                Con = new SqlConnection(connnectionString);
                //Con.ConnectionString = "Data Source=DESKTOP-OOTPH21;Initial Catalog=Library;User ID=sa;Password=123456";
                Con.Open();
            }
        ...
        {
            MessageBox.Show("Liên hệ với nhân viên bạn co thắc mắc!");
        }
